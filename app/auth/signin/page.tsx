  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        // Redirección manual para tener control
        router.push(result.url)
      } else {
        // Fallback: redirigir al callbackUrl o home
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">Sign in to your ChessMaster account</p>
          </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700">
            ...
            <div className="text-center mt-6">
              <p className="text-gray-400">
                ...
                <Link 
                  href={`/auth/newuser${callbackUrl !== '/' ? `?callbackUrl=${encodeURIComponent(callbackUrl)}` : ''}`} 
